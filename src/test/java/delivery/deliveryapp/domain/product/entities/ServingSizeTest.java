...
public class ServingSizeTest {
    ...
    void should_create_a_serving_size_with_complements() {
        var servingSizeCreated = ServingSize.create(UniqueIdentifier.create(), name, description, activedComplements, price, complementCategories);
    ...
    void should_create_an_new_serving_size() {
        var servingSizeCreated = ServingSize.createNew(name, description, activedComplements, price, complementCategories);
    ...
    void should_throw_an_exception_when_has_actived_complements_and_complementTypeId_is_null() {
        DomainException exception = Assertions.assertThrows(DomainException.class, () -> {
            ServingSize.createNew(name, description, activedComplements, price, null);
        });
