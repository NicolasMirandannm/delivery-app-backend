...
public class ProductMapperTest {
  ...
  @Mock
  private R2FileStorageService<String> r2FileStorageService;
  ...
  @Test
  void should_get_product_image_presigned_url_in_storage_service() {
    productMapper.toDomain(productSchema);
    
    Mockito.verify(r2FileStorageService, Mockito.times(1)).getObject(productSchema.getImageURI());
  }
}
